...
public class JwtUser implements UserDetails {
    ...
    public JwtUser(UUID id, String userName , String mail, String password,Integer weight, Integer age, Goal goal,Collection<? extends GrantedAuthority> authorities, boolean enabled, Date lastPasswordResetDate) {
        this.id = id;
